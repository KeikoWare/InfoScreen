...
sudo "echo mysql-server-5.5 mysql-server/root_password password K31k0Ware | debconf-set-selections"
sudo "echo mysql-server-5.5 mysql-server/root_password_again password K31k0Ware | debconf-set-selections"
