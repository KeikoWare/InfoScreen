...
sudo echo mysql-server-5.5 mysql-server/root_password password xyzzy | debconf-set-selections
sudo echo mysql-server-5.5 mysql-server/root_password_again password xyzzy | debconf-set-selections
