...
//
mysql_query("
CREATE DATABASE `infoscreen` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
");
//USE `infoscreen`;
...
$sql = "INSERT INTO IS_usergrouprel (userid, groupid) VALUES (1, 1)";
mysql_query($sql);

$sql = "INSERT INTO IS_userrights (groupid, type, typeid) VALUES (1, 'menu', 2)";
mysql_query($sql);

$sql = "INSERT INTO IS_userrights (groupid, type, typeid) VALUES (1, 'menu', 3)";
mysql_query($sql);

$sql = "INSERT INTO IS_userrights (groupid, type, typeid) VALUES (1, 'menu', 4)";
mysql_query($sql);

$sql = "INSERT INTO IS_userrights (groupid, type, typeid) VALUES (1, 'menu', 5)";
mysql_query($sql);

$sql = "INSERT INTO IS_userrights (groupid, type, typeid) VALUES (1, 'menu', 6)";
mysql_query($sql);

$sql = "INSERT INTO IS_systemdata (sdtype, sdvalue) VALUES ('zoom', '75')";
mysql_query($sql);

$sql = "INSERT INTO IS_systemdata (sdtype, sdvalue) VALUES ('version', '1.15CS')";
mysql_query($sql);

$sql = "INSERT INTO IS_systemdata (sdtype, sdvalue) VALUES ('reload', '')";
mysql_query($sql);
